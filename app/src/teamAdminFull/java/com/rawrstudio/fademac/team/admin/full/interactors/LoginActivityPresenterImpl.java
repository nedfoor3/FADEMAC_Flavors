package com.rawrstudio.fademac.team.admin.full.interactors;

import android.app.Activity;
import android.os.CountDownTimer;
import android.widget.Toast;

import com.rawrstudio.fademac.interactors.LoginActivityModelImpl;
                    ...
                    new CountDownTimer(2000, 1000) {
                        public void onFinish() {
                            ...
                            if (usuario.getNombre()== null){
                                ...
                                Toast.makeText(context, "VALIDO full", Toast.LENGTH_SHORT).show();
